...
export default function PivotEngine(){
  ...
  const scrollTop=()=>{if(mainRef.current)mainRef.current.scrollTop=0;scrollTop()}
...
<div class="footer"><span>Reimagine by Career Club · career.club</span><span>${esc(date)}</span></div>
  ...
  const rStep=()=>{switch(step){
    ...
    case'p1':return <div>
      ...
      {!isDemo&&<div style={S.row}><Btn secondary onClick={()=>{out('p1','');scrollTop()}}><RotateCcw size={13}/>Start fresh</Btn><Btn onClick={()=>advance('p1','p2')}>Explore My Wiring <ChevronRight size={14}/></Btn></div>}
      </>}
      {err&&<ErrBox msg={err}/>}
    </div>
    ...
    case'p2':return <div>
      ...
      {outputs.p2&&<>
        ...
        {!isDemo&&<div style={S.row}><Btn secondary onClick={()=>{out('p2','');scrollTop()}}><RotateCcw size={13}/>Start fresh</Btn><Btn onClick={()=>advance('p2','p3')}>Build My Brand <ChevronRight size={14}/></Btn></div>}
      </>}
      {err&&<ErrBox msg={err}/>}
    </div>
    ...
    case'p3':return <div>
      ...
      {outputs.p3&&<>
        ...
        {!isDemo&&<div style={S.row}><Btn secondary onClick={()=>{out('p3','');setP3Intro(false);scrollTop()}}><RotateCcw size={13}/>Start fresh</Btn><Btn onClick={()=>advance('p3','p4')}>See My Options <ChevronRight size={14}/></Btn></div>}
      </>}
      {err&&<ErrBox msg={err}/>}
      ...
      return <div>
        ...
        {outputs.p5&&<>
          ...
          {!isDemo&&<>
            ...
            <div style={S.row}>
              <Btn secondary onClick={()=>{out('p5','');scrollTop()}}><RotateCcw size={13}/>Start fresh</Btn>
      ...
      {outputs.p7&&(()=>{
        ...
        return <>
          ...
          {!isDemo&&<div style={S.row}>
            <Btn secondary onClick={()=>{out('p7','');setP7Intro(false);scrollTop()}}><RotateCcw size={13}/>Start fresh</Btn>
    ...
    case'p9':return <div>
      ...
      {outputs.p9&&<>
        ...
        {!isDemo&&<div style={S.row}><Btn secondary onClick={()=>{out('p9','');out('p10','');out('p11','');setP9Intro(false);setStoryUpdated({});scrollTop()}}><RotateCcw size={13}/>Start fresh</Btn><Btn onClick={()=>{markDone('p9');markDone('p10');advance('p9','complete')}}>Complete My Reimagine <ChevronRight size={14}/></Btn></div>}
      </>}
      {err&&<ErrBox msg={err}/>}
      {done.includes('complete')&&<div style={{marginTop:32,paddingTop:20,borderTop:`1px solid ${C.border}`}}><Btn onClick={()=>{nav('complete');scrollTop()}} style={backBtnStyle}><ArrowLeft size={14}/>Back to My Results</Btn></div>}
    </div>
    ...
    case'income':return <div>
      ...
      {outputs.income&&<>
        ...
        {!isDemo&&<div style={S.row}><Btn secondary onClick={()=>{out('income','');setIncomeIntro(false);scrollTop()}}><RotateCcw size={13}/>Start fresh</Btn><Btn onClick={()=>nav('complete')}><ArrowLeft size={13}/>Back to Results</Btn></div>}
      </>}
      {err&&<ErrBox msg={err}/>}
    </div>
