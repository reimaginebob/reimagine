...
export default function PivotEngine(){
  ...
  const IP={loc:{country:'',city:'',work:[]},resume:'',resumeFile:'',assess:'',assessFile:'',assessType:'',values:'',passions:'',rep:{memory:'',emergency:'',twoWords:'',other:''},corrections:[],jd:'',jdFile:''}
