...
const P={
  ...
  income:(pr,outs,sel)=>`Generate a complete Income Now plan for this professional. They are pursuing: **${sel}** as their longer-term goal, but need to generate income during the transition.\n\nPROFILE: ${outs.p1}\n${outs.p2}\n${outs.p3}\nPASSIONS: ${pr.passions}\nLOCATION: ${pr.loc.country}${pr.loc.city?', '+pr.loc.city:''} | WORK: ${pr.loc.work}\n\n**PART 1 — RECOMMENDED TRACKS**: Recommend which income tracks fit this person: Senior-Priced Gig Services, Fractional Leadership, and Passion-Adjacent Consulting. Do not dismiss gig platforms for senior professionals. The difference is pricing and positioning, not the platform. A former Fortune 500 CMO offering brand strategy at $5,000 per engagement is a gig. An executive coach offering resume reviews and career strategy sessions at $750-$1,500 per session is a gig. Senior professionals are leaving real money on the table by assuming gig platforms are for junior freelancers. Make a specific, honest call on which tracks fit this person and why.\n\n**PART 2 — SENIOR-PRICED GIG SERVICES**: Identify 3-5 specific high-value services this person can offer at rates that reflect their seniority — think $500 to $5,000 per engagement or $200-$500 per hour. For each: what the service is (be specific), who buys it and why, realistic price point, and the best platform or channel to find the first client (Upwork, Fiverr Pro, LinkedIn Services, direct outreach, or other). Then write ready-to-paste copy: profile headline, bio (150 words max), and top 3 service listings with descriptions and prices. The goal is outcome-based pricing, not hourly competition. A person with deep experience should charge for what they know, not how long it takes.\n\n**PART 3 — FRACTIONAL LEADERSHIP PITCH**: One tight paragraph for cold LinkedIn outreach or email. Plain language, no jargon. Specific about what they do and the business result it creates. Clear call to action at the end.\n\n**PART 4 — PASSION-ADJACENT CONSULTING**: Identify 3 real, near-term opportunities this person could land in the next 60 days — not abstract Ikigai concepts, but specific engagements with specific buyers. Each must sit at the intersection of their proven professional skills and their stated passions. For each: the specific service, the specific buyer type, why this person is credible to that buyer, a realistic price point, and one concrete action to find the first client this week. The standard is: could this person send an outreach message tomorrow? If not, it is too vague.\n\n**PART 5 — THE ONE SHEET**: Complete text for a professional one sheet. Sections: Who I Am (2 sentences, no job titles), What I Offer (3 specific service bullets with price ranges), Who I Serve (specific buyer description), What You Can Expect (2-3 outcome statements framed as made money/saved money/mitigated risk), How to Engage Me (rates, availability, contact). Ready to paste into a Word doc.\n\n**PART 6 — SETUP CHECKLIST**: Step by step for getting live within 48 hours. Upwork/Fiverr Pro account creation, profile completion, first proposal or gig strategy. LinkedIn Services tab setup. One action they can take today.\n\nTone: direct, practical, no hype. Treat this person as a senior professional who has underestimated their market value in these channels.`
}
