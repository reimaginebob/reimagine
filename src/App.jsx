...
const P={
  ...
  income:(pr,outs,sel)=>`You are building an Income Now plan for this professional. They are pursuing: **${sel}** as their longer-term goal and need income during the transition.\n\nPROFILE: ${outs.p1}\n${outs.p2}\n${outs.p3}\nPASSIONS: ${pr.passions}\nLOCATION: ${pr.loc.country}${pr.loc.city?', '+pr.loc.city:''} | WORK: ${pr.loc.work}\n\n**PART 1 — THE RIGHT PLATFORMS FOR THIS PERSON**: Based on their specific background, identify the 4-6 platforms where they would have the most credibility and the best chance of landing paid work quickly. Do not default to a generic list. Think carefully about their function, industry, and seniority and match them to platforms built for people like them.\n\nExamples of how to think about this — a former CHRO or HR leader: Catalant, Business Talent Group, Bolste, Learnerbly (if L&D focused). A CFO or finance executive: Toptal Finance, Graphite, CFO Alliance. A tech or product executive: Toptal, Arc, Gun.io, Expert360. A marketing or brand leader: GrowthMentor, Credo, Expert360, Bark. A strategy or general management executive: Catalant, Business Talent Group, Umbrex, AlixPartners alumni network. A sales leader: Bravado, Toptal, direct fractional CFO/CRO platforms. A board-ready executive: OnBoard, Boardlist, Bolste. General senior consulting across functions: Upwork Pro, Fiverr Pro, LinkedIn Services, Lunchclub.\n\nFor each recommended platform: the platform name, why it fits this specific person, the type of work available, realistic earning range, and the first step to get listed or active.\n\n**PART 2 — SENIOR GIG SERVICES**: Write ready-to-use profile copy priced at senior market rates — $250-$500/hour for advisory work, $500-$2,500 for defined deliverables, $3,000-$8,000 for strategic engagements. Senior professionals face almost no competition at this price point because most assume these platforms are for junior talent.\n\nWrite the following:\n- Profile headline (under 100 characters, works across platforms)\n- Bio (150 words, first person, outcome-focused)\n- 4 specific service offerings with title, one-line description, and price — based on their actual background and adapted to the platforms recommended above\n- Recommended first action to get the first paying client within 7 days\n\n**PART 3 — FRACTIONAL LEADERSHIP PITCH**: One tight paragraph for cold LinkedIn outreach or direct email. Plain language. Specific about the business problem they solve and the result they create. Clear call to action.\n\n**PART 4 — PASSION-ADJACENT CONSULTING**: 3 specific engagements this person could land within 60 days at the intersection of their professional skills and stated passions. For each: the specific service, the specific buyer, why this person is credible, realistic price, and one action to take this week.\n\n**PART 5 — THE ONE SHEET**: Complete text ready to paste into a Word doc. Sections: Who I Am (2 sentences, no job titles), What I Offer (3 service bullets with price ranges), Who I Serve, What You Can Expect (outcomes as made money/saved money/mitigated risk), How to Engage Me (rates, availability, contact).\n\n**PART 6 — FIRST 48 HOURS**: Exactly what to do in the next two days to have a profile live or an outreach message sent. Specific steps only.\n\nTone: direct and practical. Write everything as if it will be used today.`
}
