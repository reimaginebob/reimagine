...
const P={
  ...
  income:(pr,outs,sel)=>`You are building an Income Now plan for this professional. They are pursuing: **${sel}** as their longer-term goal and need income during the transition.\n\nPROFILE: ${outs.p1}\n${outs.p2}\n${outs.p3}\nPASSIONS: ${pr.passions}\nLOCATION: ${pr.loc.country}${pr.loc.city?', '+pr.loc.city:''} | WORK: ${pr.loc.work}\n\nFRAMING PRINCIPLE: Income Now opportunities live primarily in Lane 1 — the modernized, senior version of what this person already does well. They do not need to reinvent themselves to generate income. They need to package what they already know and sell it directly to people who need it right now. Some Lane 2 opportunities (selling their industry expertise into adjacent markets) may apply. Lane 3 (full reinvention) is not relevant here — that is the longer-term goal, not the income bridge.\n\nPITCH PRINCIPLE: Frame everything around the buyer's pain, not the seller's biography. People buy painkillers, not vitamins. They act when something is hurting, not when life could theoretically be better. Every service description, outreach message, and one-sheet section should start by naming a real problem the buyer is living with right now. The buyer does not care where this person worked or what their title was. They care whether their problem goes away. Lead with the pain. Follow with how this person fixes it. Close with what it costs and how to start. The "if you're struggling with X" framing is a useful gut-check, not a rigid template.\n\n**PART 1 — THE RIGHT PLATFORMS FOR THIS PERSON**: Based on their specific background, identify 4-6 platforms where they have the most credibility and the best chance of landing paid work quickly. Match them to platforms built for people at their level and in their function.\n\nExamples: HR/talent leader: Catalant, Business Talent Group, Bolste. Finance executive: Toptal Finance, Graphite, CFO Alliance. Tech/product executive: Toptal, Arc, Expert360. Marketing/brand leader: GrowthMentor, Credo, Expert360. Strategy/general management: Catalant, Business Talent Group, Umbrex. Sales leader: Bravado, Toptal. Board-ready executive: Boardlist, OnBoard. Broad senior consulting: Upwork Pro, Fiverr Pro, LinkedIn Services.\n\nFor each platform: name, why it fits this specific person, type of work available, realistic earning range, and first step to get listed.\n\n**PART 2 — SERVICE OFFERINGS**: Identify 4 specific services this person can offer right now based on Lane 1 (their core expertise, modernized and packaged for direct sale). For each service, write:\n- A problem-first title. Not "Leadership Coaching" — something like "Helping mid-market CEOs who are losing their best people and don't know why"\n- The specific pain the buyer is experiencing that this service addresses\n- What the engagement looks like (scope, format, timeline)\n- The outcome the buyer can expect, framed as made money / saved money / mitigated risk\n- Price point at senior market rates ($300-$500/hour advisory, $1,000-$5,000 project, $3,000-$10,000 strategic engagement)\n- Best platform or channel to find this buyer\n\n**PART 3 — PROFILE COPY**: Write ready-to-use copy for the best-fit platform identified above.\n- Headline (under 100 characters, problem-oriented not title-oriented)\n- Bio (150 words, first person, leads with the problem they solve, ends with a specific outcome they have delivered)\n- One outreach message template following this structure: name the pain in sentence 1, connect one specific accomplishment to that pain in sentences 2-3, ask for 15 minutes as a peer conversation in sentence 4. Plain language. No buzzwords. Sounds like a human.\n\n**PART 4 — FRACTIONAL PITCH**: One paragraph for cold LinkedIn or email using the same problem-first structure. What pain does the buyer have. How does this person solve it. What does it cost and how do they engage.\n\n**PART 5 — THE ONE SHEET**: Problem-first structure throughout. Sections: The Problem I Solve (2 sentences), How I Help (3 specific service bullets with prices), Who I Work With (specific buyer), What Happens When We Work Together (2-3 outcomes as made money/saved money/mitigated risk), How to Start (rates, availability, contact).\n\n**PART 6 — FIRST 48 HOURS**: Exactly what to do in the next two days to have a profile live or an outreach message sent. Specific steps only.\n\nTone: direct and practical. Every word should serve the buyer, not the seller's ego.`
}
...
const SHUFFLED_QUOTES=[...QUOTES].sort(()=>Math.random()-0.5)
