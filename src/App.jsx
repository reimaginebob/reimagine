...
const S={
  ...
  helperText:{fontSize:14,color:'#4A5568',lineHeight:1.55,margin:'4px 0 10px'},
  footnote:{fontSize:13,color:'#718096',lineHeight:1.5,margin:'8px 0 0'},
}
...
export default function PivotEngine(){
  ...
  const IP={loc:{country:'',city:'',work:[]},resume:'',resumeFile:'',linkedin:'',linkedinFile:'',assess:'',assessFile:'',assessType:'',values:'',passions:'',rep:{memory:'',emergency:'',twoWords:'',other:''},corrections:[],jd:'',jdFile:''}
