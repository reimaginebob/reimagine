...
export default function PivotEngine(){
  ...
  const IP={loc:{country:'',city:'',work:[]},resume:'',resumeFile:'',assess:'',assessFile:'',assessType:'',values:'',passions:'',rep:{memory:'',emergency:'',twoWords:'',other:''},corrections:[]}
  ...
  const downloadAllMarkdown=()=>{
    ...
    const stepNames={p1:'Resume Analysis',p2:'Wiring & Compass',p3:'Brand Synthesis',p4:'Wide View',p5:'Deep Dive',p6:'Bridge Story / Tell Me About Yourself',p7:'Go-To-Market',p8:'LinkedIn Refresh',p_res:'Resume Refresh',p9:'Playbook & Interview Prep & Negotiation',income:'Income Now'}
