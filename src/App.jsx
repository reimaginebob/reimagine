...
<div class="footer"><span>Reimagine by Career Club · career.club</span><span>${esc(date)}</span></div>
  ...
  const rStep=()=>{switch(step){
    ...
    case'op':{
      ...
      const opSections=[{id:'companyRead',label:'About This Company',num:1},{id:'p5',label:'The Role',num:2},{id:'p6',label:'Bridge Story',num:3},{id:'p_res',label:'Resume Refresh',num:4},{id:'panel',label:'Interview Team'},{id:'p11',label:'Interview Prep',num:5}]
