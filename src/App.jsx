...
const P={
  ...
  income:(pr,outs,sel)=>`Generate a complete Income Now plan for this professional. They are pursuing: **${sel}** as their longer-term goal, but need to generate income during the transition.\n\nPROFILE: ${outs.p1}\n${outs.p2}\n${outs.p3}\nPASSIONS: ${pr.passions}\nLOCATION: ${pr.loc.country}${pr.loc.city?', '+pr.loc.city:''} | WORK: ${pr.loc.work}\n\nCRITICAL INSTRUCTION: You MUST recommend gig platform services for this person regardless of their seniority. Do not suggest gig platforms are inappropriate for senior professionals. That instinct is wrong. The insight is this: senior professionals can use these platforms at senior prices. A former Fortune 500 CMO can offer brand strategy on Fiverr Pro for $5,000. An executive with 20 years in HR can offer resume reviews and career strategy sessions on Upwork for $500-$1,500 each. A CFO can offer financial model reviews for $2,000. The platform is just distribution. The rate and the offer are theirs to set. Most senior professionals are not doing this, which means there is almost no competition at the top of the market on these platforms. This is a genuine opportunity that is being missed.\n\n**PART 1 — HOW TO THINK ABOUT THIS**: Briefly explain the three income tracks and why all three apply to this person: Senior-Priced Gig Services, Fractional Leadership, and Passion-Adjacent Consulting. Emphasize that gig platforms at senior pricing are an underused lane with low competition.\n\n**PART 2 — SENIOR-PRICED GIG SERVICES (required for everyone)**: Identify 4-5 specific high-value services this person can offer right now, priced at their actual seniority level — minimum $300 per hour or $500 per engagement, up to $5,000+ for project work. For each service: what it is specifically, who buys it, realistic price point, and the best channel (Upwork, Fiverr Pro, LinkedIn Services, direct outreach). Then write ready-to-paste profile copy: headline, bio (150 words), and 3 service listings with titles, descriptions, and prices. Price high. A senior professional competing on rate is leaving money on the table.\n\n**PART 3 — FRACTIONAL LEADERSHIP PITCH**: One tight paragraph for cold LinkedIn outreach or email. Plain language, no jargon. Specific about what they deliver and the business result. Clear call to action.\n\n**PART 4 — PASSION-ADJACENT CONSULTING**: Identify 3 specific engagements this person could realistically land within 60 days at the intersection of their professional skills and stated passions. Not abstract concepts — real services, real buyers, real price points. For each: the service, the buyer, why this person is credible, price, and one action to take this week to find the first client.\n\n**PART 5 — THE ONE SHEET**: Complete text ready to paste into a Word doc. Sections: Who I Am (2 sentences, no job titles), What I Offer (3 service bullets with price ranges), Who I Serve, What You Can Expect (outcomes framed as made money/saved money/mitigated risk), How to Engage Me (rates, availability, contact).\n\n**PART 6 — FIRST 48 HOURS**: Exactly what to do in the next two days to have something live or sent. Specific steps for Upwork or Fiverr Pro account setup, LinkedIn Services tab, and one direct outreach message they can send today.\n\nTone: direct, practical, no hedging. Treat this person as a senior professional who has been underestimating their market value in these channels.`
}
