...
export default function PivotEngine(){
  ...
  const IP={loc:{country:'',city:'',work:''},resume:'',resumeFile:'',linkedin:'',linkedinFile:'',assess:'',assessFile:'',assessType:'',values:'',passions:'',rep:{memory:'',emergency:'',twoWords:'',other:''}}
...
<div class="footer"><span>Reimagine by Career Club · career.club</span><span>${esc(date)}</span></div>
  ...
  const pc={loc:profile.loc,resume:profile.resume,linkedin:profile.linkedin||'',assess:profile.assess,assessType:profile.assessType,values:profile.values,passions:profile.passions,rep:profile.rep}
  ...
  const rStep=()=>{switch(step){
    ...
    case'resume':return <div>
      ...
      <div style={{...S.card,marginTop:20,background:`${C.gold}04`,border:`1.5px solid ${C.gold}25`}}>
        ...
        <div style={{fontSize:15,color:'#4A5568',lineHeight:1.65,marginBottom:16}}>Your resume shows what you have done. Your LinkedIn profile shows how others describe your work — recommendations, endorsements, and how you position yourself publicly. It takes 30 seconds: go to your LinkedIn profile, click <strong>More</strong> → <strong>Save to PDF</strong>, then upload it here.</div>
