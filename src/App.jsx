...
// p8 prompt also instructs the model to reproduce keys literally (belt), but
// this deterministic pass is the guarantee.
function normalizeP8KeyDrift(obj,canonKeys,requireArray){
...
function normalizeP8TopLevelKeys(obj){
  if(normalizeP8KeyDrift(obj,P8_TOP_LEVEL_KEYS,false)){try{console.warn('[p8] top-level key drift normalized to canonical; model emitted mangled keys')}catch{}}
}
function normalizeP8SkillsDeltaKeys(sd){
  if(normalizeP8KeyDrift(sd,P8_SKILLS_DELTA_KEYS,true)){try{console.warn('[p8] skills_delta key drift normalized to canonical; model emitted mangled keys')}catch{}}
}
