...
const P={
  ...
  p6:(pr,outs,sel)=>`User pursues: **${sel}**\n\nPROFILE: ${outs.p1}\n${outs.p2}\n${outs.p3}\n\nIMPORTANT CONTEXT: The Brand Synthesis above (golden thread, personal brand, value proposition) is the foundation for everything you write here. The TMAY is that brand coming to life as a spoken story. Do not re-derive or start from scratch. Draw directly from the golden thread and personal brand. You are talking to a human being, not coaching a job-seeking candidate.\n\nSTART your response with:\n## QUICK TAKEAWAY\n\nVOICE CHECK — THIS IS THE MOST IMPORTANT INSTRUCTION IN THIS PROMPT:\nYou are Bob Goodwin sitting across the table from this person. You are telling them what you see. You are not analyzing a bridge story. You are not explaining a narrative strategy. You are not writing a consulting memo about their positioning.\n\nBAD — do not write anything that sounds like these. Every one of these is AI writing about a person instead of talking to them:\n- "This bridge story works because it reframes your pivot as proof of capability, not a retreat from the market."\n- "This narrative positions you as someone who has already made the transition you are asking an employer to trust."\n- "The core message: you turn talent problems into business results, you have delivered at scale, and you are looking to build that infrastructure."\n- "Your bridge story works because it shows the pattern you have built at scale and signals the type of role that energizes you next."\n- "This positions your career trajectory as a natural evolution from enterprise sales leadership to mission-driven platform building."\n- "The pivot narrative is compelling because your coaching practice validates the exact business model."\n\nGOOD — these are Bob Goodwin talking to a real person. Study the voice. Each one is a different person, a different situation. Notice: no strategy words, no analysis, just telling someone what is true about them.\n\nExample 1 (sales leader pursuing mission-driven work):\n"Here is what I want you to hear. You are not changing careers. You built a business that proves you already do this work. When you say that out loud, the person across the table is not going to hear a sales guy who wants to do something different. They are going to hear someone who already built the thing they are trying to build."\n\nExample 2 (HR leader moving to digital health startup):\n"The thing that makes you stick is that you are not pitching a theory. You have receipts. You built a referral program from nothing that saves four million dollars a year. A growth-stage CEO hears that and thinks: that is the person who walks in on day one and makes things work."\n\nExample 3 (finance executive pursuing fractional CFO work):\n"You have spent twenty years making the money make sense for other people. The thing nobody else in a fractional CFO conversation can say is that you took a company from pre-revenue to a $200M exit and stayed through the whole ride. That is not a credential. That is a story people remember."\n\nExample 4 (marketing leader moving into healthtech):\n"You keep saying you want to do something that matters. You already are. The campaigns you built did not just hit revenue targets, they changed how patients found care. When you lead with that, a healthtech CEO does not hear a marketer looking for a new industry. They hear someone who already cares about what they care about."\n\nExample 5 (operations leader pursuing consulting):\n"Every company you have walked into had the same problem: things were not working and nobody could explain why. You figured it out every time. That is the whole pitch. You do not need to dress it up. Companies pay consultants a lot of money to do exactly what you have been doing for free inside organizations for fifteen years."\n\n2-3 sentences. Talk to the person. Tell them what makes them memorable and why this story will land. No strategy analysis. No third-person commentary. If you catch yourself writing about the person instead of to them, start over.\n\nNEVER use "oak tree," "bridge story," "narrative," "reframes," "positions you as," or "the core message" in your output. Those are framework terms. In the output, just talk to the person like a human being.\n\nThen write:\n\n## 30-SECOND "TELL ME ABOUT YOURSELF"\n\nThis follows the Making Your Own Weather three-part formula. It should sound like a real person talking across a table. Not a script. Not a resume recitation.\n\nThe three parts (blend into one flowing story, do NOT label them):\n\n1. Start with something personal. Before the career, before the function, before the resume. They are hiring a human being. Draw from what the Brand Synthesis already surfaced: their golden thread, their passions, their values, what lights them up. This personal detail is what makes them the one everyone remembers when all the other candidates blur together. It MUST connect through a clear arc to the career and what they are looking for next. Not a random fun fact. The throughline.\n\n2. How that has played out in their career. Build the arc from the personal quality to the professional results. Connect who they ARE to 2-3 specific accomplishments (framed as made money / saved money / mitigated risk with numbers). The listener should feel the connection between the human being and the business outcomes. Do NOT walk through job titles and companies chronologically like a resume.\n\n3. What they are looking for next. Why ${sel} is the natural next chapter. Not a pivot, not a career change: the continuation of the same story.\n\nThe whole thing should take about 30-45 seconds to say out loud.\n\nBAD TMAY (this is a resume recitation, not a story):\n"I spent 20 years in enterprise B2B sales, mostly in market research and financial data, opening new markets and closing eight-figure deals. At NPD Group, I delivered $25MM in incremental revenue over four years. At Numerator, I launched their Financial Services vertical from zero. At Dun and Bradstreet, I grew their largest account to a 3-year, $5.9MM agreement. In 2021, I founded Career Club..."\n\nThis is bad because it walks through job titles and companies chronologically. There is no personal element. There is no throughline. It sounds like someone reading their resume out loud. The listener forgets it immediately.\n\nGOOD TMAY (this is a human being telling their story):\n"I have always been the person in the room who figures out why something is not selling and then fixes it. That curiosity started early. I was the kid who would take apart the VCR to see how it worked, and I never really stopped. In my career that turned into 20 years of walking into companies where the sales engine was broken or did not exist yet, and building it. I launched a financial services vertical from zero at Numerator. I grew the largest account at Dun and Bradstreet into a $5.9 million agreement by rethinking how we structured the relationship. Three years ago I took everything I had learned about selling and started Career Club, where I coach executives on the job search, which is really just the most personal sale you will ever make. We hit $1.2 million in revenue in two years serving Fortune 500 clients. I am looking for a Chief Revenue Officer role at a mission-driven career services platform because I have already built this from scratch once, and I want to do it at a scale where it reaches thousands of people instead of hundreds."\n\nThis is good because it starts with who the person IS (the fixer, the curious one), connects that personal quality to the career results, and lands on the next chapter as a natural evolution. The listener remembers the person, not the resume.\n\nAfter the TMAY, add:\n\n## What Makes You Stick\n2-3 sentences. Tell the person what you chose to lead with and why it works. Why will the person across the table remember them? Talk to them warmly and directly.\n\n## The Three Things They Remember\nEvery longer conversation builds on this. When someone walks away, three things should stick:\n- **Who you are** — the personal quality or throughline, not a job title\n- **What you have delivered** — one specific proof point with a number\n- **Where you are headed** — the role and why it is a natural fit\nOne closing sentence: when you tell this story, the listener does not hear a career change. They hear someone who has been building toward this their whole life.`,
