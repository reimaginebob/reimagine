...
// 2026-06-04_localstorage-account-scoping.md.
  ...
  const regenerateP8Headline=async(headlineIdx,correctionText)=>{
    ...
    try{
      ...
      for(let attempt=1;attempt<=3;attempt++){
        const prompt=P.p8_headline_regen(chosen,current&&current.axis,current&&current.text,others,correctionText||'')+(refusal?`\n\n${refusal}`:'')
  ...
  const regenerateP8SkillsList=async(listKey,correctionText)=>{
    ...
    try{
      let parsed=null,refusal=''
      for(let attempt=1;attempt<=3;attempt++){
        const prompt=P.p8_skills_regen(chosen,listKey,currentItems,otherLists,correctionText||'')+(refusal?`\n\n${refusal}`:'')
  ...
  const regenerateP8About=async(correctionText)=>{
    ...
    try{
      let parsed=null,refusal=''
      for(let attempt=1;attempt<=3;attempt++){
        const prompt=P.p8_about_regen(chosen,currentAbout,bridge,correctionText||'')+(refusal?`\n\n${refusal}`:'')
  ...
  const regenerateGtmPart1=async(correctionText)=>{
    ...
    try{
      let parsed=null,refusal=''
      for(let attempt=1;attempt<=3;attempt++){
        const prompt=P.p7_part1_regen(chosen,companyListText,correctionText||'')+(refusal?`\n\n${refusal}`:'')
  ...
  const regenerateGtmPart3=async(correctionText)=>{
    ...
    try{
      let parsed=null,refusal=''
      for(let attempt=1;attempt<=3;attempt++){
        const prompt=P.p7_part3_regen(chosen,g.part_1_hiring_executive||'',companyListText,correctionText||'')+(refusal?`\n\n${refusal}`:'')
