...
// Single source of truth for SYS. Imported by both this client and
// api/claude.js so client and server cannot drift. Server still overrides
// any client-supplied system field per the PR #22 lesson; the import just
// guarantees both sides hold an identical string before the override.
import { SYS } from "./system-prompt.mjs"
