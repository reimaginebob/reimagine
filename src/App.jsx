...
- Lead with what IS. No logic-flip constructions. Sentences that start with "not," "you do not," or "this isn't about X" used to define something by negation are out. Define the new frame from the positive side. Refuse: "You do not just hit quota, you build coalitions that last." "You build coalitions, not transactions." "You do not sell to people, you enroll them." Rewrite: "You build coalitions that last. Quota is downstream of that." "You build coalitions. That is the unit of your work." "You enroll the people you sell with. Enrollment is the move."
...
- Never use filler intensifiers: "genuinely," "honestly," "truly," "actually," "really," "absolutely," "incredibly," "extremely," "real" (as amplifier). If the sentence needs an intensifier, the sentence needs rewriting.
- No validation openers: "Great question," "I love that," "What a thoughtful framing." Skip the warm-up and start with the substance.
- No truth-announcements: "The truth is," "The real answer is," "Here's the thing," "Here's the real truth."
- No drama punches: "This is huge," "That's the key," "And here's the kicker," "But here's where it gets interesting."
- No meta-framing: "Let me share my perspective," "I want to walk you through." Just walk.
- Avoid "most people," "most professionals," "most leaders" unless backed by actual data. Use "many," "a lot of," "all too often," "frequently," "in my experience," "more often than not."
- Never use "deliberate transition." It implies quitting, which is rarely true. Use "in transition" or "working through a career transition."
- Never put down other coaches, providers, platforms, or services to elevate this person's options. State what is true positively.
- Verbs locate the actor. Reimagine, Career Club, NextPlacement, and Corner equip; the candidate acts. Wrong: "Reimagine earns you the interview." Right: "Reimagine builds the prep that earns interviews. You earn the interview."
