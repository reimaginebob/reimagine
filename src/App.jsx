...
export default function PivotEngine(){
  ...
  const IP={loc:{country:'',city:'',work:[]},resume:'',resumeFile:'',linkedin:'',linkedinFile:'',assess:'',assessFile:'',assessType:'',values:'',passions:'',rep:{memory:'',emergency:'',twoWords:'',other:''},lifeEvents:'',corrections:[],frameworks:[],jd:'',jdFile:''}
  ...
  const downloadAllMarkdown=()=>{
    ...
    const stepNames={p1:'Resume Analysis',p2:'Wiring & Compass',p3:'Brand Synthesis',p4:'Role Options',p5:'The Role',p6:'Bridge Story / Tell Me About Yourself',p7:'Go-To-Market',p8:'LinkedIn Remix',p_res:'Resume Refresh',p9:'Lingo & Playbook',p10:'Interview Prep',p11:'Interview Prep',income:'Income Now',op:'Live Opportunity Playbook'}
...
<div class="footer"><span>Reimagine by Career Club · career.club</span><span>${esc(date)}</span></div>
  ...
  const rStep=()=>{switch(step){
    ...
    case'focus':{
      ...
      const go=(id)=>({p5:{maxTokens:4000},p6:{maxTokens:5000},p7:{webSearch:true,maxTokens:7000},p8:{maxTokens:3500},p_res:{maxTokens:5000},p9:{maxTokens:4000},p11:{maxTokens:8000},income:{maxTokens:6000}}[id]||{})
      ...
      const renderBody=(id)=>{
        if(id==='p6')return <BridgeStoryView p6={outputs.p6} p6Legacy={outputs.p6_legacy} isDemo={isDemo} isSmallPortrait={isSmallPortrait} currentHashes={currentP6Hashes()} copied={copied} onCopy={copy} onPick={updateP6Pick} onEdit={updateP6Edit} onRegenerate={()=>generateP6()} onMigrateGenerate={regenerateP6WithoutCascade}/>
