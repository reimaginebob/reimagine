        ...
        {outputs.op?<>
          {!isDemo&&<CoachingCallout>
            ...
            <ul style={{margin:'0 0 12px 20px',padding:0}}>
              ...
              <li style={{margin:'0 0 4px'}}><strong>Preparing for the conversation:</strong> STAR stories, screening-interview prep, questions to ask, ways to show value.</li>
          ...
          {!isDemo&&<details style={{marginTop:24}}>
            ...
            <div style={{marginTop:12}}>
              ...
              <Btn onClick={()=>generate('op',()=>P.op(pc,outputs,chosen,profile.jd),{maxTokens:7500,msg:'Building your Opportunity Playbook…'})} disabled={(profile.jd||'').trim().length<100}><Sparkles size={14}/>Build a new playbook</Btn>
              {err&&<ErrBox msg={err}/>}
            </div>
          </details>}
        </>:<>
          ...
          {!isDemo&&<Btn onClick={()=>generate('op',()=>P.op(pc,outputs,chosen,profile.jd),{maxTokens:7500,msg:'Building your Opportunity Playbook…'})} disabled={(profile.jd||'').trim().length<100}><Sparkles size={14}/>Build My Playbook</Btn>}
          {err&&<ErrBox msg={err}/>}
        </>}
      </>}
    </div>}
