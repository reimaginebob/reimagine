...
Below the two cards, a single guidance line reads: *Not sure which to pick first? Most people start with Career Paths to see the range of where their background takes them, then come back to add an opportunity once they have a specific role in mind.* The two paths are not mutually exclusive. Choose either one, finish what you need, and the other is available from the sidebar entry **Put It to Work** anytime.
