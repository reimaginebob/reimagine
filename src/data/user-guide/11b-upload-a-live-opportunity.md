...
- **Offer & Negotiation** — built on your Compensation Read: where an offer sits against the sourced range (enter your number in the optional field to see it placed), and what to ask for framed as an evidence case built from your own accomplishments — the return your work produced, tied to the number, never "you deserve more" as an assertion. The card also carries two things you can use straight away without generating anything: a **total compensation checklist** (bonus payout history, benefits detail, equity, PTO utilization, and more) and a short **negotiation script library**. For the offer situations that don't have a universal answer — severance timing, take-it-or-leave-it or algorithm-set offers, reading a company's layoff history — it points you to a real conversation with My Coach. It only names market figures your Compensation Read already sourced, so build that first. Whether to accept is always your call.
