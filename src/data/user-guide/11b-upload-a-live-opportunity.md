...
- **Offer & Negotiation** — built on your Compensation Read: where an offer sits against the sourced range (enter your number in the optional field to see it placed), what to ask for and how to frame it, and the parts of a package a base-salary number hides (bonus, equity, sign-on, benefits). It only names market figures your Compensation Read already sourced, so build that first. Whether to accept is always your call.
