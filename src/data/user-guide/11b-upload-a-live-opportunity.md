...
- **Compensation Read** — a sourced pay range for this role and market, triangulated across public salary sites (Glassdoor, BuiltIn, Salary.com, PayScale, and similar), with every dollar figure linked to the source so you can check it yourself. Public sources routinely disagree, so the card names the honest spread rather than one falsely precise number, and it uses live web search. It is a starting point for your own research, not a verdict — a disclaimer under the card says exactly that. Build it when you want it.
