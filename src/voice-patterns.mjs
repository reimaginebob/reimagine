...
export const HARD_PATTERNS = [
  ...
  // --- 2026-05-27 Voice guide application -------------------------------
  //
  ...
  //   - src/data/user-guide/15-glossary.md where KEEL principles and the
  //     4 C's are legitimately documented with explicit "not exposed in
  //     outputs" notes (the rule that makes these patterns necessary in
  //     the first place)
