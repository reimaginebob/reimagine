...
// Both remaining Chat mounts carry the three new props identically (2026-09-07:
// floating bubble, concierge orientation panel; the dedicated myCoach
// embedded panel was retired 2026-09-13, One Coach consolidation).
...
check(mountHits === 2, `${APP}: expected the three life-events-thin props at both remaining <Chat> mount sites (floating, concierge orientation), found ${mountHits}`)
