...
// (known-contacts) was added; 23 on 2026-09-01, when Your STAR Stories came off
// its internal-only pilot gate and joined the catalog. The count is a tripwire
// for an accidental edit to FEATURE_MAP, so it moves deliberately with the map
