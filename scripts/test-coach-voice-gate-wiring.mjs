...
check(chatMountHits === 2,
  `${APP}: expected onVoiceViolation={handleCoachVoiceViolation} at both remaining <Chat> mount sites (floating bubble, concierge orientation panel), found ${chatMountHits}`)
